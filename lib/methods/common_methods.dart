...
import 'package:aplicacion_movilizate/appInfo/app_info.dart';
import 'package:aplicacion_movilizate/global/global_var.dart';
import 'package:http/http.dart' as http;
import 'package:aplicacion_movilizate/models/address_model.dart';
...
class CommonMethods
{
  checkConnectivity(BuildContext context) async
  {
    ...
    if(connectionResult != ConnectivityResult.mobile && connectionResult != ConnectivityResult.wifi)
    {
      ...
      displaySnackBar("Tu Internet no está disponible. Comprueba tu conexión. Intentar otra vez.", context);
    }
  }
  ...
  static Future<String> convertGeoGraphicCoOrdinatesIntoHumanReadableAddress(Position position, BuildContext context) async
  {
    ...
    {
      humanReadableAddress = responseFromAPI["resultados"][0]["dirección_formateada"];
