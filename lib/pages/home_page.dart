...
import 'package:aplicacion_movilizate/global/trip_var.dart';
import 'package:aplicacion_movilizate/methods/common_methods.dart';
import 'package:aplicacion_movilizate/methods/manage_drivers_methods.dart';
import 'package:aplicacion_movilizate/methods/push_notification_service.dart';
import 'package:aplicacion_movilizate/models/direction_details.dart';
import 'package:aplicacion_movilizate/models/online_nearby_drivers.dart';
import 'package:aplicacion_movilizate/pages/about_page.dart';
import 'package:aplicacion_movilizate/pages/search_destination_page.dart';
import 'package:aplicacion_movilizate/pages/trips_history_page.dart';
import 'package:aplicacion_movilizate/widgets/info_dialog.dart';
import 'package:aplicacion_movilizate/widgets/payment_dialog.dart';
...
class _HomePageState extends State<HomePage>
{
  ...
  retrieveDirectionDetails() async
  {
    ...
    showDialog(
      ...
      context: context,
      builder: (BuildContext context) => LoadingDialog(messageText: "Obteniendo dirección..."),
    );
    ...
    Marker pickUpPointMarker = Marker(
      ...
      infoWindow: InfoWindow(title: pickUpLocation.placeName, snippet: "Lugar de recogida"),
    );
    ...
    Marker dropOffDestinationPointMarker = Marker(
      ...
      infoWindow: InfoWindow(title: dropOffDestinationLocation.placeName, snippet: "Ubicación de destino"),
    );
  ...
  noDriverAvailable()
  {
    showDialog(
        ...
        builder: (BuildContext context) => InfoDialog(
          title: "No hay controlador disponible",
          description: "No se encontró ningún conductor en la ubicación cercana. Por favor intenta nuevamente en breve.",
        )
    );
  }
  ...
  sendNotificationToDriver(OnlineNearbyDrivers currentDriver)
  {
    ...
    tokenOfCurrentDriverRef.once().then((dataSnapshot)
    {
      ...
      var timerCountDown = Timer.periodic(oneTickPerSec, (timer)
      {
       ...
       //cuando la solicitud de viaje no es solicitada significa que la solicitud de viaje se cancela - detiene el cronómetro
        if(stateOfApp != "solicitando")
        {
          timer.cancel();
          currentDriverRef.set("cancelado");
          currentDriverRef.onDisconnect();
          requestTimeoutDriver = 20;
        }

   //cuando la solicitud de viaje es aceptada por el conductor disponible más cercano en línea
        currentDriverRef.onValue.listen((dataSnapshot)
        {
          if(dataSnapshot.snapshot.value.toString() == "aceptado")
          {
            timer.cancel();
            currentDriverRef.onDisconnect();
            requestTimeoutDriver = 20;
    ...
    //si pasaron 20 segundos - enviar notificación al siguiente conductor disponible en línea más cercano
        if(requestTimeoutDriver == 0)
        {
          currentDriverRef.set("se acabó el tiempo");
          timer.cancel();
          currentDriverRef.onDisconnect();
          requestTimeoutDriver = 20;

          //enviar notificación al siguiente conductor disponible en línea más cercano
          searchDriver();
        }
      });
    });
  ...
  Widget build(BuildContext context)
  {
    ...
    return Scaffold(
            ...
            children: [
              ...
              GestureDetector(
                ...
                child: ListTile(
                  ...
                  title: const Text("Historia", style: TextStyle(color: Colors.grey),),
                ),
              ),
     ...
     /// botón de icono de ubicación de búsqueda
          Positioned(
            left: 0,
            right: 0,
            bottom: -80,
                ...
                children: [
                  ...
                  ElevatedButton(
                    onPressed: () async
                    {
                      ...
                      if(responseFromSearchPage == "lugarSeleccionado")
                      {
...
/// contenedor de detalles del viaje
          Positioned(
            left: 0,
            right: 0,
            bottom: 0,
